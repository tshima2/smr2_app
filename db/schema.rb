...
ActiveRecord::Schema.define(version: 2022_02_10_034219) do

  create_table "assigns", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "team_id"
  ...
  create_table "image_posts", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.text "image"
    t.bigint "user_id"
    t.bigint "site_id"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.integer "keep_team_id", default: 1, null: false
